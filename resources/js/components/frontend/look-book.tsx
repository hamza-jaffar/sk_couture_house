...
import type { FeaturedCollection, FrontendData, CollectionItemType, Frontend } from '@/types/auth';
...
export const Lookbook: React.FC<LookbookProps> = ({ featuredCollection, frontendData }) => {
